...
public class SignUpActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        categoryView = findViewById(R.id.setUpPreferences);
        categoryView.setLayoutManager(layoutManager);

        CategoryViewAdapter adapter = new CategoryViewAdapter(SignUpActivity.this, mCategoryNames);
        categoryView.setAdapter(adapter);

        EditText bioInput = findViewById(R.id.setBio);
        TextView bioValidation = findViewById(R.id.setBioAlert);
        TextView categoryValidation = findViewById(R.id.selectCategoryAlert);
        Button setProfileBtn = findViewById(R.id.setupProfileButton);

        EditText ageInput = findViewById(R.id.setAge);
        TextView ageValidation = findViewById(R.id.setAgeAlert);
